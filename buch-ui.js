...
const TX = {
  de:{
    ...
    bNewInvoice:'Rechnung aus dieser Kalkulation', bNewEntry:'Beleg erfassen',
  ...
  ua:{
    ...
    bVatWatch:'Поріг ПДВ', bVatNote:'{p} % від CHF 100’000 річного обороту. Після цієї межі ПДВ стає обовʼязковим.',
    bNewInvoice:'Рахунок із цього розрахунку', bNewEntry:'Внести документ',
    ...
    bIbanQrNon:'QR-IBAN вимагає обовʼязкової QR-референції.',
    ...
    bLegalText:'Одноосібні підприємства з оборотом до CHF 500’000 ведуть спрощений облік за ст. 957 абз. 2 CO: надходження, витрати та майновий стан. Подвійна бухгалтерія з балансом не обовʼязкова. Документи зберігаються десять років. Цей інструмент не замінює податкову чи юридичну консультацію.',
    ...
    bNoCalc:'Спочатку внеси імʼя клієнта та ціну в розрахунку.',
